...
func TestChaosPoolInvariants(t *testing.T) {
	...
	client := newTestRedis(t, Config{Host: addr, PoolSize: chaosPoolSize, MaxIdleConns: chaosPoolSize, MaxRetries: 1, CommandTimeout: 500 * time.Millisecond, PoolTimeout: 50 * time.Millisecond})
