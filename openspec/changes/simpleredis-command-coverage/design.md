...
3. **Eval isolation.** Pester POSTs the Kong KEYS script to `/eval`. EVALSHA miss-then-hit is two POSTs after `SCRIPT FLUSH`. Digest is SHA-1 of the body Pester sent.
